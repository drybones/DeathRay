...
New-AzureResourceGroup -Name 'DeathRay' -TemplateFile '..\Templates\WebSiteSQLDatabase.json' -TemplateParameterFile '..\Templates\WebSiteSQLDatabase.param.dev.json' -Force -Verbose
